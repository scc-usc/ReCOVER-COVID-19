...
function evaluateProp(prop, props) {
  return (0, _isFunction2.default)(prop) ? prop(props) : prop;
}
  ...
  var traverseChildren = function (childArray, names, parent) {
    return childArray.reduce(function (memo, child, index) {
      ...
      if (child.props && child.props.children) {
        ...
        var nestedChildren = child.type && child.type.role === "stack" && (0, _isFunction2.default)(child.type.getChildren) ? child.type.getChildren(childProps) : _react.default.Children.toArray(child.props.children).map(function (c) {
