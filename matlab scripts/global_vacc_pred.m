...
vacc_pre_immunity = equiv_vacc_effi*((1 - un.*data_4./popu).*vacc_one);
vacc_per_day = (vacc_one(:, end) - vacc_one(:, end-14))/14;
vacc_future  = vacc_one(:, end) + cumsum(vacc_per_day*ones(1, horizon), 2);
