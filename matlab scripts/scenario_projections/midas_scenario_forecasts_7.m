...
best_param_list(:, 1) = 2; best_param_list(:, 2) = 7; best_param_list(:, 3) = 0.9;
best_death_hyperparam(:, 1) = 4; 
best_death_hyperparam(:, 2) = 7;
best_death_hyperparam(:, 3) = 50;
best_death_hyperparam(:, 4) = 2;

best_hosp_hyperparam(:, 1) = 3;
best_hosp_hyperparam(:, 2) = 7;
best_hosp_hyperparam(:, 3) = 50;
best_hosp_hyperparam(:, 4) = 1;
...
vacc_effi1_delta = 0.5; vacc_effi2_delta = 0.9 - vacc_effi1_delta;
...
vacc_effi1 = 0.5; vacc_effi2 = 0.9 - vacc_effi1;
vacc_effi1_delta = 0.35; vacc_effi2_delta = 0.85 - vacc_effi1_delta;
trans_adv = 1.6;
